...
console.  You're not going to learn much about functions if
...
for line in code_lines:
    ...
    if  (   (score_prediction_2 != 0)
        or  (inflated_score_prediction_2 != 0)):
        result = check_int_prediction(10,
                                      'score_prediction_2',
                                      line,
                                      'second')
    ...
    if  (   (score_prediction_3 != 0)
        or  (inflated_score_prediction_3 != 0)):
        result = check_int_prediction(10,
                                      'score_prediction_3',
                                      line,
                                      'third')
    ...
    if  (   (score_prediction_4 != 0)
        or  (inflated_score_prediction_4 != 0)
        or  (inflation_prediction_4 != 0)):
        result = check_int_prediction(10,
                                      'score_prediction_4',
                                      line,
                                      'fourth')
        if (result != True):
            return result
        result = check_int_prediction(25,
                                      'inflated_score_prediction_4',
                                      line,
                                      'fourth')
        if (result != True):
            return result
        result = check_int_prediction(15,
                                      'inflation_prediction_4',
                                      line,
                                      'fourth')
        if (result != True):
            return result
    ...
    if  (   (score_prediction_5 != 0)
        or  (inflated_score_prediction_5 != 0)
        or  (inflation_prediction_5 != 0)):
        result = check_int_prediction(25,
                                      'score_prediction_5',
                                      line,
                                      'fifth')
        if (result != True):
            return result
        result = check_int_prediction(25,
                                      'inflated_score_prediction_5',
                                      line,
                                      'fifth')
        if (result != True):
            return result
        result = check_int_prediction(15,
                                      'inflation_prediction_5',
                                      line,
                                      'fifth')
        if (result != True):
            return result
